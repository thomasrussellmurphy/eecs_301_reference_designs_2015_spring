...
# ACDS 13.1 162 win32 2015.02.20.20:40:35
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/quad_bank_fir_rtl_u0_m0_wo0_wi0_ra1_count1_lut_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/quad_bank_fir_rtl.vhd"                          
  vhdlan -xlrm "$QSYS_SIMDIR/quad_bank_fir_ast.vhd"                          
  vhdlan -xlrm "$QSYS_SIMDIR/quad_bank_fir.vhd"                              
  vhdlan -xlrm "$QSYS_SIMDIR/quad_bank_fir_tb.vhd"                           
fi
