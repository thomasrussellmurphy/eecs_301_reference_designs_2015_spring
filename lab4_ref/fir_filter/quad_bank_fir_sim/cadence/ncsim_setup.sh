...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/quad_bank_fir_rtl.vhd"                          
  ncvhdl -v93 "$QSYS_SIMDIR/quad_bank_fir_ast.vhd"                          
  ncvhdl -v93 "$QSYS_SIMDIR/quad_bank_fir.vhd"                              
  ncvhdl -v93 "$QSYS_SIMDIR/quad_bank_fir_tb.vhd"                           
fi
