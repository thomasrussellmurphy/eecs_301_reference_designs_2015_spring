...
for j = 1:sx
    ...
    %
    file_name = ['quad_bank_fir_input.txt'];
    ...
    for i = 1: num_ch
     ...
     % run this output through the model 
      if(bankcount>1)
        output = quad_bank_fir_mlab(data_channel, bank_channel);
      else
        output = quad_bank_fir_mlab(data_channel);
      end
    ...
    file_name = ['quad_bank_fir_model_output'];
